...
Formatter = (function(superClass) {
  ...
  Formatter.prototype._init = function() {
    this.editor = this._module;
    this._allowedTags = $.merge(['br', 'a', 'img', 'b', 'strong', 'i', 'strike', 'u', 'p', 'ul', 'ol', 'li', 'blockquote', 'pre', 'code', 'h1', 'h2', 'h3', 'h4', 'hr'], this.opts.allowedTags);
...
Toolbar = (function(superClass) {
  ...
  Toolbar.prototype._init = function() {
    ...
    if (!this.opts.toolbarHidden && this.opts.toolbarPosition === 'top' && this.opts.toolbarFloat) {
  ...
  Toolbar.prototype._render = function() {
    var k, len, name, ref;
    this.buttons = [];
    if (this.opts.toolbarPosition === 'bottom') {
      this.wrapper = $(this._tpl.wrapper).appendTo(this.editor.wrapper);
      this.editor.wrapper.addClass('toolbar-bottom');
    } else {
...
Simditor = (function(superClass) {
  ...
  Simditor.prototype.sync = function() {
    ...
    if (typeof this.opts.onsync === 'function') {
      val = this.opts.onsync(val);
    }
    this.textarea.val(val);
    return val;
  };
...
BoldButton = (function(superClass) {
  ...
  BoldButton.prototype.htmlTag = 'b';
...
ImageButton = (function(superClass) {
    ...
    this.editor.uploader.on('beforeupload', (function(_this) {
      return function(e, file) {
        ...
        return _this.editor.uploader.readImageFile(file.obj, function(img) {
          ...
          return _this.loadImage($img, src, null, function() {
    ...
    this.editor.uploader.on('uploadsuccess', (function(_this) {
      return function(e, file, result) {
        ...
        if (result.success === false) {
          error = result.error || _this._t('uploadFailed');
          if ($.isFunction(_this.onImageLoadError)) {
            _this.onImageLoadError(error);
          }
          $img.attr({
            src: '',
            alt: _this.errorImageText
          }).addClass('simditor-image-error');
          return _this.finishLoading($img);
        } else {
  ...
  ImageButton.prototype.finishLoading = function($img) {
    var $mask;
    $img.removeData('file');
    ...
    if (this.popover.active) {
      this.popover.srcEl.prop('disabled', false);
      this.popover.srcEl.val(this.errorImageText);
    }
    this.editor.trigger('valuechanged');
    if (this.editor.body.find('img.uploading').length < 1) {
      return this.editor.uploader.trigger('uploadready', [file, result]);
    }
  };

  ImageButton.prototype.loadImage = function($img, src, attach_id, callback) {
    ...
    img.onload = (function(_this) {
      return function() {
        ...
        if (attach_id) {
          $img.attr('data-attach-id', attach_id);
        }
        if ($img.hasClass('uploading')) {
  ...
  ImageButton.prototype.command = function(src) {
    ...
    return this.loadImage($img, src || this.defaultImage, null, (function(_this) {
      return function() {
